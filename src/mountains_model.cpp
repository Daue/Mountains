	...
	: QAbstractListModel( _parent )
{
	...
	add( "Mogielica", "Beskid Wyspowy", 1173, QPointF( 49.655320270343466, 20.276677187363447 ) );
	...
	add( "Wielka Sowa", "Góry Sowie", 1015, QPointF( 50.68027699271707, 16.485556634387535 ) );
	...
	add( "Kłodzka Góra", "Góry Bardzkie", 765, QPointF( 50.45166897225994, 16.753220590584277 ) );
